select 
    ...
    case
        ...
        when (emp.salario > 2826.66 and emp.salario <=3751.06) then (emp.salario * 0.15) - 370.4
        when (emp.salario > 3751.06 and emp.salario <=4664.68) then (emp.salario * 0.225) - 651.73
